# Generated by Powerlevel10k configuration wizard on 2021-01-02 at 17:56 CST.
...
() {
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_COMMITS_BEHIND )) && res+=" ${clean}ﰬ${VCS_STATUS_COMMITS_BEHIND}"
    # ⇡42 if ahead of the remote; no leading space if also behind the remote: ⇣42⇡42.
    (( VCS_STATUS_COMMITS_AHEAD && !VCS_STATUS_COMMITS_BEHIND )) && res+=" "
    (( VCS_STATUS_COMMITS_AHEAD  )) && res+="${clean}ﰵ${VCS_STATUS_COMMITS_AHEAD}"
    # ⇠42 if behind the push remote.
    (( VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" ${cilean}ﰯ${VCS_STATUS_PUSH_COMMITS_BEHIND}"
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=$(hexcolor 40 '#4eb401')
  typeset -g POWERLEVEL9K_STATUS_OK_BACKGROUND=$(hexcolor 244 '#3f5771')
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND=$(hexcolor 196 '#ff5252')
  typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND=$(hexcolor 244 '#3f5771')
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=$(hexcolor 252 '#b1b2b3')
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=$(hexcolor 237 '#304357')
  # typeset -g POWERLEVEL9K_TIME_FOREGROUND=$(hexcolor 0 '#101521')
  # typeset -g POWERLEVEL9K_TIME_BACKGROUND=$(hexcolor 140 '#a37acc')
